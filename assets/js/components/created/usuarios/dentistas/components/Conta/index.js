...
import { index, show, update, store } from "~/services/controller";
...
function Conta({ id }) {
  ...
  const [filters, setFilters] = useState({
    dentista_id: id || params.id,
    created_at: "",
    tipo: "all"
  });

  useEffect(() => {
    index("financeiro_dentista", {
      dentista_id: filters.dentista_id,
      tipo: filters.tipo,
